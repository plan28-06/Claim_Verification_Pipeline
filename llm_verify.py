...
if __name__ == "__main__":
    ...
    PDF_PATH = (
        ...
        r"\2006-Carturan-Strengthening of soda-lime silica "
        r"glass by surface tereatement with sol-gel silica.pdf"
    )

    CLAIM = (
        "Sol–gel silica coating increased the fracture "
        "resistance of annealed soda-lime-silica glass "
        "by approximately 35 MPa."
    )
    ...
    print(
        f"\nSupporting evidence:"
        f" {result['supporting_evidence']}"
    )

    print(
        f"Contradicting evidence:"
        f" {result['contradicting_evidence']}"
    )
